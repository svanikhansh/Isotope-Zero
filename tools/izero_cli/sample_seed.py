...
def seed_sample_db(db_path: str | None = None) -> str:
    ...
    cards = [
        ...
        ("card-001", "The user prefers dark mode for the terminal.",
         ...
         8, 5, now - 120, None),
        ("card-002", "The project is a pure-Python package with a NumPy/BLAS similarity kernel.",
         "core/native.py: 'HAVE_NATIVE = False; batch_cosine_similarity runs on numpy BLAS'",
         ["tech", "stack", "python"], _norm([0.0, 0.95, 0.1, 0.3, 0.0, 0.2]),
         12, 3, now - 3600, None),
